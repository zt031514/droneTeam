...
{  
    ...
    //Run the first port pin initialization for ETH WIZ - CMH
    ...
    do{
        ...
        if(discard == 0){
            ...
            //ETH WIZ pic send OPTION 1
            lepton_send_packet_option1();
        
            //ETH WIZ pic sendOPTION 2
            //lepton_send_packet_option2();    
        }
