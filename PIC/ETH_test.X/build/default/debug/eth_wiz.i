...
uint8_t one = SPI_ETHWIZ_Write(0x00);
uint8_t two = SPI_ETHWIZ_Write(0x00);
uint8_t three = SPI_ETHWIZ_Write(0x00);
uint8_t four = SPI_ETHWIZ_Write(0x00);
PORTDbits.RD3 = 1;
...
SPI_ETHWIZ_Write(0x02);
SPI_ETHWIZ_Write(s0_reg_read);
s0_IR_check = SPI_ETHWIZ_Write(0x00);
s0_SR_check = SPI_ETHWIZ_Write(0x00);
PORTDbits.RD3 = 1;
...
SPI_ETHWIZ_Write(s0_tx_buf_write);
...
void eth_wiz_transmit_end_single_byte(void){
