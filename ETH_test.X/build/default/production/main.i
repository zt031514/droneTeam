...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\pic16f18875.h"
...
extern void eth_wiz_configure_client(void);
extern void eth_wiz_createSocket_client(void);

extern void eth_wiz_transmit_end_single_byte(void);

# 26 "main.c"
uint8_t packet_length = 164;
uint8_t image_packet[164];
uint8_t num_of_packets = 60;
int8_t packet_index = 60;
uint8_t discard = 0;
uint8_t num_discard = 0;



void lepton_capture_packet_option1(void);
void lepton_capture_packet_option2(void);
void lepton_send_packet_option1(void);
void lepton_send_packet_option2(void);
...
eth_wiz_configure();
printf("ETH WIZ Configured\n\n\r");


eth_wiz_createSocket();
printf("Socket Created and Connection Made as a Server\n\n\r");
...
SPI_ETHWIZ_Write(0x02);
SPI_ETHWIZ_Write(0b00001000);
